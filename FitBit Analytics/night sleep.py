# -*- coding: utf-8 -*-
"""
Created on Sat May  5 12:56:00 2018
...
dec_plot = df_subplot_Dec.plot.bar(legend=False,fontsize = 4,title = '{} Day-Night Sleep in Dec'.format(Name))
...
jan_plot = df_subplot_Jan.plot.bar(legend=False,fontsize = 4,title = '{} Day-Night Sleep in Jan'.format(Name))
...
feb_plot = df_subplot_Feb.plot.bar(legend=False,fontsize = 4,title = '{} Day-Night Sleep in Feb'.format(Name))
